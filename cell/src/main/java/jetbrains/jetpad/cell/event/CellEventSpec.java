...
public class CellEventSpec<EventT extends Event> {
  ...
  public static final CellEventSpec<MouseEvent> MOUSE_ENTERED = new CellEventSpec<MouseEvent>("mouseEntered");
  public static final CellEventSpec<MouseEvent> MOUSE_LEFT = new CellEventSpec<MouseEvent>("mouseLeft");
