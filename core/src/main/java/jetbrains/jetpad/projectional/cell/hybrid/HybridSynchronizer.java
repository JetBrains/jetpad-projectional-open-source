...
import jetbrains.jetpad.projectional.cell.util.*;
...
import jetbrains.jetpad.projectional.parser.prettyprint.ParseNodes;
import jetbrains.jetpad.values.Color;

import java.util.*;

import static jetbrains.jetpad.projectional.cell.hybrid.SelectionPosition.FIRST;
import static jetbrains.jetpad.projectional.cell.hybrid.SelectionPosition.LAST;
...
public class HybridSynchronizer<SourceT> implements Synchronizer {
  ...
  private Cell createTokenCell(Token token) {
    if (token instanceof ValueToken) {
      ...
      Cells.firstFocusableLeaf(target).addTrait(new TokenCellTraits.LeftLeafTokenCellTrait());
      Cells.lastFocusableLeaf(target).addTrait(new TokenCellTraits.RightLeafTokenCellTrait());
