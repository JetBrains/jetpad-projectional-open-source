...
import jetbrains.jetpad.projectional.cell.hybrid.testapp.mapper.ExprHybridPositionSpec;
import jetbrains.jetpad.projectional.cell.hybrid.testapp.mapper.Tokens;
import jetbrains.jetpad.projectional.cell.hybrid.testapp.model.Expr;
import jetbrains.jetpad.projectional.cell.hybrid.testapp.model.NumberExpr;
import jetbrains.jetpad.projectional.cell.hybrid.testapp.model.PlusExpr;
...
public class TokenListEditorTest {
  private TokenListEditor<Expr> editor = new TokenListEditor<Expr>(new ExprHybridPositionSpec());
