...
class TokensUtil {
  ...
  static Token singleQtd(String body) {
    return new ValueToken(new StringExpr("'", body), null);
  }
  ...
  static Token complex() {
    return new ValueToken(new ComplexValueExpr(), null);
  }

  static Token pos() {
    return new ValueToken(new PosValueExpr(), null);
  }

  static Token value() {
    return new ValueToken(new ValueExpr(), null);
  }
