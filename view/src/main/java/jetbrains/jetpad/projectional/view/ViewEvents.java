...
public class ViewEvents {
  ...
  public final static ViewEventSpec<MouseEvent> MOUSE_ENTERED = new ViewEventSpec<MouseEvent>("mouseEntered");
  public final static ViewEventSpec<MouseEvent> MOUSE_LEFT = new ViewEventSpec<MouseEvent>("mouseLeft");
